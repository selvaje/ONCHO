...
#SBATCH -n 1 -c 1 -N 1
#SBATCH -t 24:00:00 
#SBATCH -o /vast/palmer/scratch/sbsc/ga254/stdout/sc06_sentinel_merge90m_odm.sh.%J.out
#SBATCH -e /vast/palmer/scratch/sbsc/ga254/stderr/sc06_sentinel_merge90m_odm.sh.%J.err
#SBATCH --job-name=sc06_sentinel_merge90m_odm.sh
#SBATCH --mem=40G

#### sbatch /vast/palmer/home.grace/ga254/scripts_gitreps/ONCHO/sc06_sentinel_merge90m_odm.sh
...
##### oft 
##### cd ~/bin
#####  apptainer build   opendronemap.sif   docker://opendronemap/odm 

apptainer exec  ~/bin/opendronemap.sif  bash <<EOF
