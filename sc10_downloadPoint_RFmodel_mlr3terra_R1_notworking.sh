...
table = read.table("x_y_pa_predictors4R_adultpresent.txt", header = TRUE, sep = " ")
...
write.table(table.rf.vs, paste0("../vector_seed",seed,"/pa_predictors_selvsVar_seed",seed,".txt"), quote = FALSE  )
...
tablexy = read.table("abridged_consolidated_x_y_uniq_header_adultpresent.txt", header = TRUE, sep = " ")
...
learnerP = lrn("classif.ranger", predict_types = "prob" , importance = "permutation", properties = "twoclass" ) 
